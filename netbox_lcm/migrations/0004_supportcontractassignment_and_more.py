...
def migrate_to_assignments(apps, schema_editor):
    ...
    SupportContractDeviceAssignment = apps.get_model('netbox_lcm', 'SupportContractDeviceAssignment')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('netbox_lcm', '0003_remove_supportcontract_devices_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_object_type', models.ForeignKey(blank=True, limit_choices_to=('dcim.Device', 'netbox_lcm.License'), null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='contenttypes.contenttype')),
                ('contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netbox_lcm.supportcontract')),
