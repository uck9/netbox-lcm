...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('netbox_lcm', '0004_supportcontractassignment_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='sku',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='netbox_lcm.supportsku'),
        ),
    ]
