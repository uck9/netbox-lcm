...
def migrate_assigned_object_forward(apps, schema_editor):
    SupportContractAssignment = apps.get_model('netbox_lcm', 'SupportContractAssignment')
    LicenseAssignment = apps.get_model('netbox_lcm', 'LicenseAssignment')
...
def migrate_assigned_object_reverse(apps, schema_editor):
    ...
    license_type = ContentType.objects.get(app_label='netbox_lcm', model='licenseassignment')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('netbox_lcm', '0010_licenseassignment_quantity'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='supportcontractassignment',
            name='license',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contracts', to='netbox_lcm.licenseassignment'),
        ),
        ...
        migrations.RemoveConstraint(
            model_name='supportcontractassignment',
            name='netbox_lcm_supportcontractassignment_unique_assignments',
        ),
        migrations.RemoveConstraint(
            model_name='supportcontractassignment',
            name='netbox_lcm_supportcontractassignment_unique_assignment_null_sku',
        ),
