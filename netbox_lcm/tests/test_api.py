...
from netbox_lcm.utilities.gfk_mixins import DateFieldMixin


class AppTest(APITestCase):
    def test_root(self):
        url = reverse("plugins-api:netbox_lcm-api:api-root")
...
class VendorTest(APIViewTestCases.APIViewTestCase):
    model = Vendor
    view_namespace = "plugins-api:netbox_lcm"
...
class LicenseAssignmentTest(APIViewTestCases.APIViewTestCase):
    ...
    user_permissions = ('netbox_lcm.view_license', 'netbox_lcm.view_vendor', 'dcim.view_device', )
...
class SupportContractTest(APIViewTestCases.APIViewTestCase):
    ...
    user_permissions = ('netbox_lcm.view_supportsku', 'netbox_lcm.view_vendor', )
...
class SupportContractAssignmentTest(APIViewTestCases.APIViewTestCase):
    ...
    user_permissions = ('netbox_lcm.view_supportcontract', 'netbox_lcm.view_vendor', 'dcim.view_device', )
