...
from netbox_lcm.utilities.gfk_mixins import HardwareLifecycleViewMixin
from netbox_lcm.utilities.testing import create_test_vendor
...
class VendorTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:vendor_{}'
...
class LicenseTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:license_{}'
...
class LicenseAssignmentTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:licenseassignment_{}'
...
class SupportContractTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:supportcontract_{}'
...
class SupportSKUTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:supportsku_{}'
...
class SupportContractAssignmentTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:supportcontractassignment_{}'
...
class HardwareLifecycleTestCase(
    ...
    def _get_base_url(self):
        return 'plugins:netbox_lcm:hardwarelifecycle_{}'
