...
from netbox_lcm.filtersets import LicenseFilterSet, LicenseAssignmentFilterSet
from netbox_lcm.forms import LicenseFilterForm, LicenseForm, LicenseAssignmentForm, \
...
from netbox_lcm.tables import LicenseTable, LicenseAssignmentTable
...
class LicenseAssignmentsView(ObjectChildrenView):
    template_name = 'netbox_lcm/license/assignments.html'
    queryset = License.objects.all()
